...
#define SRM_CMD_STEPPER_CW_REQ    0x40U
#define SRM_CMD_STEPPER_CW_RSP    0x41U

#define SRM_CMD_STEPPER_CCW_REQ   0x42U
#define SRM_CMD_STEPPER_CCW_RSP   0x43U

#define SRM_CMD_STEPPER_HOME_REQ  0x44U
#define SRM_CMD_STEPPER_HOME_RSP  0x45U
